...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE price SET location_id='$location_id', field_id='$field_id', category='$category', type='$type', url='$url' WHERE id=$id");
            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['staff_id']; ?></span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Update Court</h1>
                                ...
                                <div class="card-body">
                                    <form action="price-edit.php" method="post">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input type="text" value="Jam" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="url">
                                                <option disabled selected> Choose </option>
                                                <option value="bronze">Court 1</option>
                                                <option value="silver">Court 2</option>
                                                <option value="gold">Court 3</option>
                                                <option value="platinum">Court 4</option>
                                            </select>
                                        </div>
