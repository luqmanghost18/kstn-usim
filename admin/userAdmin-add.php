    ...
    <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="userAdmin-add.php" method="post">
      ...
      <!-- Proses Add -->
                ...
                if(isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($mysqli, "INSERT INTO admin (nama, staff_id, password, level) VALUES('$nama', '$staff_id', sha1('$password'), '$level')");
                    
                    // Show message when user added
                    echo "<br>";
                    echo "<div class='alert alert-success col-lg-6' role='alert' style='margin-left:10px;'>";
                    echo "<b>Succesful!</b> Data has been updated. <a href='userAdmin.php' class='alert-link'>Click here</a> to go back.";
                    echo "</div>";
