...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE admin SET nama='$nama', staff_id='$staff_id', password=sha1('$password'), level='$level' WHERE id=$id");
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="userAdmin-edit.php" method="post">
